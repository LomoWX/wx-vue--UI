  ...
  export default {
    ...
    components: {
      'el-menu-collapse-transition': {
        ...
        render(createWxement, context) {
          ...
          return createWxement('transition', data, context.children);
        }
      }
    },
    ...
    watch: {
      ...
      collapse(value) {
        ...
        this.broadcast('WxSubmenu', 'toggle-collapse', value);
      }
    },
    methods: {
        ...
        if (this.router && hasIndex) {
          this.routeToItem(item, (error) => {
            ...
            if (error) {
              ...
              // https://github.com/WxemeFE/element/issues/17044
