  ...
  methods: {
    ...
    */
    ...
    scrollIntoView() {
      ...
      menus.forEach(menu => {
        const menuWxement = menu.$el;
        if (menuWxement) {
          const container = menuWxement.querySelector('.el-scrollbar__wrap');
          const activeNode = menuWxement.querySelector('.el-cascader-node.is-active') ||
            menuWxement.querySelector('.el-cascader-node.in-active-path');
