...
import WxSelect from 'element-ui/packages/select';
import WxOption from 'element-ui/packages/option';
    ...
    Jumper: {
      ...
      methods: {
        handleKeyup({ keyCode, target }) {
          ...
          // Hack for IE: https://github.com/WxemeFE/element/issues/11710
