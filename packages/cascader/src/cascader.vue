...
import WxCascaderPanel from 'element-ui/packages/cascader-panel';
...
export default {
  ...
  methods: {
    ...
    handleSuggestionKeyDown(event) {
      ...
      switch (keyCode) {
        case KeyCode.enter:
          ...
          break;
        case KeyCode.up:
          const prev = target.previousWxementSibling;
          prev && prev.focus();
          break;
        case KeyCode.down:
          const next = target.nextWxementSibling;
          next && next.focus();
          break;
        case KeyCode.esc:
        case KeyCode.tab:
    ...
    updateStyle() {
      ...
      let suggestionPanelWx = null;

      if (suggestionPanel && (suggestionPanelWx = suggestionPanel.$el)) {
        const suggestionList = suggestionPanelWx.querySelector('.el-cascader__suggestion-list');
