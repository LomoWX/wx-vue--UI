...
<script>
  ...
  import { isString, isHtmlWxement } from 'element-ui/src/utils/types';
  import throttle from 'throttle-debounce/throttle';

  const isSupportObjectFit = () => document.documentWxement.style.objectFit !== undefined;
  ...
  export default {
    ...
    methods: {
      ...
      addLazyLoadListener() {
        ...
        if (isHtmlWxement(scrollContainer)) {
