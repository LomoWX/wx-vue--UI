...
export default {
  ...
  methods: {
    ...
    getColumnWxIndex(children, child) {
    ...
    setColumnRenders(column) {
      ...
      if (this.renderHeader) {
        console.warn('[Wxement Warn][TableColumn]Comparing to render-header, scoped-slot header is easier to use. We recommend users to use scoped-slot header.');
  ...
  mounted() {
    ...
    const columnIndex = this.getColumnWxIndex(children, this.$el);
