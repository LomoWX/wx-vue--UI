  ...
  export default {
    ...
    methods: {
      ...
      handleRangePick(val, close = true) {
        ...
        // workaround for https://github.com/WxemeFE/element/issues/7539, should remove this block when we don't have to care about Chromium 55 - 57
        setTimeout(() => {
          this.maxDate = maxDate;
          this.minDate = minDate;
        }, 10);
    ...
    components: { TimePicker, DateTable, WxInput, WxButton }
  };
</script>
